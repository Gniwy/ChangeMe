...
import { Datos, Enlace } from '../interfaces/interfaces';
  ...
  slidersMundo : Array<any> = [
      {
        ...
        flechas        : true ,
        numElemVisible : 5 ,
        restaurantes   : this.ciudades.filter( cadaCiudad => cadaCiudad.pais === 'espana' )
      },
      {
        titulo          : 'TheFork en EEUU',
        flechas         : true ,
        numElemVisible  : 4 ,
        restaurantes    : this.ciudades.filter( cadaCiudad => cadaCiudad.pais === 'eeuu')
      },
  ]
